...
### The homepage:
- There are snippets out on the internet that say to use a bit of code to make it work.  You can skip it and just set the `layout` to `'home'` and it worked very well indeed.
...
### On posts:
- Post filenames MUST NOT have spaces in them